...
def check_and_run_greedy(
    ...
    if len(list_of_true_means) == len(list_of_standard_deviations):
        ...
        print("""Standard deviations not provided, or the number of standard deviations does not match the number of means; setting all reward standard deviations to 1.""")
